...
get_header_site ('Добавление новости', 'Добавление новости', 'Электронная библиотека храма святого Великомученика и Целителя Пантелеимона <br> г. Ставрополь');
new_menu ();
// get_sm_menu ();
get_sm_sidebar ();
									...
									<div class="d-flex flex-row justify-content-center">
										...
										<div class="d-flex flex-row justify-content-center">
											...
											<div class="d-flex m-5">
												...
												<button type="submit" onclick="return removeDone(this)" name="ok" class="btn btn-primary">Готово</button>
