...
get_header_site ('Добавление нового блока издания', 'Добавление нового блока издания', 'Электронная библиотека храма святого Великомученика и Целителя Пантелеимона <br> г. Ставрополь');
new_menu ();
// get_sidebar ();
