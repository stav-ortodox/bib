...
if (isset($_SESSION['id'])) {
    ...
    $errors[] = 'Для того чтобы отправить письмо зарегистрируйтесь или авторизируйтесь!';
...
if (empty($subject)) $errors[] = 'Не указана тема сообщения';
if (empty($text)) $errors[] = 'Вы ничего не написали';
