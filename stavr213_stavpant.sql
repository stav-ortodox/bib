...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 27 2019 г., 00:51
...
CREATE TABLE `calendar` (
  `id` int(11) NOT NULL,
  `month` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `days` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
